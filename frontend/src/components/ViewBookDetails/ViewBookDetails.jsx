...
const ViewBookDetails = () => {
  ...
  return (
    ...
    {Data && <div  className='px-6   md:px-12 py-8 bg-zinc-900 flex flex-col lg:flex-row gap-4 items-start'>
    ...
    <div className='flex flex-col md:flex-row lg:flex-col mt-4 lg:mt-0 items-center justify-between lg:justify-start'>
      ...
      <span className='ms-4 block lg:hidden'>Favourites</span>
        ...
        <button className='text-white rounded md:mt-0 lg:rounded-full text-3xl p-3 mt-8 lg:mt-8 bg-blue-500 flex items-center justify-center'onClick={handleCart}>
        <FaCartShopping />{" "}
